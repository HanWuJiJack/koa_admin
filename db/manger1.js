...
db.getCollection("faas").insert([ {
    ...
    lastLoginTime: ISODate("2022-06-29T07:01:44.817Z"),
    method: "put",
    fn: "// put\nmodule.exports = async () => {\n    const { id } = ctx.request.body\n    const { ...params } = ctx.request.body;\n    params.updateTime = new Date();\n    const res = await modelSchemas.formSchema.findOneAndUpdate({ id }, params, { new: true });\n    return Tools.success({ data: res, msg: '修改成功！' })\n}",
    code: "form",
...
db.getCollection("faas").insert([ {
    _id: ObjectId("6544583b813ad41cf2f9caa7"),
    state: NumberInt("1"),
    createTime: ISODate("2023-11-03T02:09:09.444Z"),
    lastLoginTime: ISODate("2023-11-03T02:09:09.444Z"),
    method: "get",
...
db.getCollection("form").insert([ {
    _id: ObjectId("65445d9b7ea1e206d4334494"),
    state: NumberInt("1"),
    createTime: ISODate("2023-11-03T02:37:30.864Z"),
    lastLoginTime: ISODate("2023-11-03T02:37:30.864Z"),
    id: NumberInt("1"),
    code: "888",
    name: "3",
    config: "2",
...
db.getCollection("menus").insert([ {
    ...
    parentId: [
        ObjectId("6543462c59c20018ca80753e")
    ],
    createTime: ISODate("2022-06-24T04:57:20.742Z"),
    updateTime: ISODate("2023-11-02T06:59:32.235Z"),
    menuType: NumberInt("2"),
    menuState: NumberInt("1"),
    menuName: "函数",
    isShow: NumberInt("1"),
...
db.getCollection("menus").insert([ {
    _id: ObjectId("6543462c59c20018ca80753e"),
    menuState: NumberInt("1"),
    isShow: NumberInt("1"),
    parentId: [
        null
    ],
    createTime: ISODate("2023-11-02T06:31:24.546Z"),
    updateTime: ISODate("2023-11-02T06:48:59.626Z"),
    menuType: NumberInt("1"),
    menuName: "FAAS",
    component: "blankpage/index",
    path: "/faas",
...
db.getCollection("menus").insert([ {
    _id: ObjectId("654346a659c20018ca80755d"),
    menuState: NumberInt("1"),
    isShow: NumberInt("1"),
    parentId: [
        ObjectId("6543462c59c20018ca80753e")
    ...
    createTime: ISODate("2023-11-02T06:31:24.546Z"),
    updateTime: ISODate("2023-11-02T06:59:42.496Z"),
    menuType: NumberInt("2"),
...
db.getCollection("menus").insert([ {
    _id: ObjectId("654349df59c20018ca8075d1"),
    menuState: NumberInt("1"),
    isShow: NumberInt("1"),
    parentId: [
        ObjectId("6543462c59c20018ca80753e"),
        ObjectId("654346a659c20018ca80755d")
    ],
    createTime: ISODate("2023-11-02T06:31:24.546Z"),
    updateTime: ISODate("2023-11-02T06:31:24.546Z"),
    menuType: NumberInt("3"),
    menuName: "列表",
    menuCode: "model-list",
    path: "",
...
db.getCollection("menus").insert([ {
    _id: ObjectId("654349ef59c20018ca8075d8"),
    menuState: NumberInt("1"),
    isShow: NumberInt("1"),
    parentId: [
        ObjectId("6543462c59c20018ca80753e"),
...
db.getCollection("menus").insert([ {
    _id: ObjectId("654349ff59c20018ca8075df"),
    menuState: NumberInt("1"),
    isShow: NumberInt("1"),
    parentId: [
        ObjectId("6543462c59c20018ca80753e"),
...
db.getCollection("menus").insert([ {
    _id: ObjectId("65434a1159c20018ca8075e6"),
    menuState: NumberInt("1"),
    isShow: NumberInt("1"),
    parentId: [
        ObjectId("6543462c59c20018ca80753e"),
...
db.getCollection("menus").insert([ {
    _id: ObjectId("65434a3b59c20018ca8075fc"),
    menuState: NumberInt("1"),
    isShow: NumberInt("1"),
    parentId: [
        ObjectId("6543462c59c20018ca80753e"),
...
db.getCollection("model").insert([ {
    _id: ObjectId("6544433d4c23e20b54a85c8d"),
    state: NumberInt("1"),
    createTime: ISODate("2023-11-03T00:46:52.001Z"),
    lastLoginTime: ISODate("2023-11-03T00:46:52.001Z"),
    id: NumberInt("6"),
...
db.getCollection("model").insert([ {
    _id: ObjectId("654456f4813ad41cf2f9ca37"),
    state: NumberInt("1"),
    createTime: ISODate("2023-11-03T02:09:09.456Z"),
    lastLoginTime: ISODate("2023-11-03T02:09:09.456Z"),
    id: NumberInt("11"),
    name: "project",
    func: "module.exports = async () => {\n    if (!modelSchemas.projectSchema) {\n        modelSchemas.projectSchema = mongoose.model('project', mongoose.Schema({\n            \"name\": String,\n            \"startTime\": {\n                type: Date,\n                default: Date.now()\n            },\n            \"makeTime\": {\n                type: Date,\n                default: Date.now()\n            },\n            \"endTime\": {\n                type: Date,\n                default: Date.now()\n            },\n            \"state\": {\n                type: String,\n                default: 1\n            },\n            \"company\": String,\n            userInfo: {\n                type: mongoose.Schema.Types.ObjectId,\n                ref: 'users'\n            },\n            \"createTime\": {\n                type: Date,\n                default: Date.now()\n            },\n            \"lastLoginTime\": {\n                type: Date,\n                default: Date.now()\n            },\n            remark: String\n        }, {\n            autoIndex: true,\n            autoCreate: true\n        }), 'project')\n    }\n}",
    __v: NumberInt("0")
} ]);
