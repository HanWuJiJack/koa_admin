    ...
    <div class="bottom">
      <div class="bottom-top">
        <el-button
          type="primary"
          @click="addHandler"
          v-permisson="'goods-create'"
          >新增</el-button
        >
        <el-button
          type="primary"
          @click="addHandler('goods')"
      ...
      <el-dialog
        title="上传商品清单"
        v-model="xlsxForm.dialogVisible"
        width="400px"
      >
        <el-upload
      ...
      <el-dialog
        title="上传作品"
        v-model="goodsFileForm.dialogVisible"
        width="80%"
      >
        <el-upload
          accept="image/*"
      ...
      <el-dialog
        title="批量更新单号"
        v-model="expressForm.dialogVisible"
        width="400px"
      >
        <el-form
...
export default {
  ...
  setup() {
    ...
    const afterAvatarGoodsUpload_ = async (uploadFile, uploadFiles) => {
      ...
      const uploadFiles_ = JSON.parse(JSON.stringify(uploadFiles)).filter(
        (item) => {
          return item.size;
        }
      );
    ...
    return {
      ...
      handleGoodsRemove,
      afterAvatarGoodsUpload,
      afterAvatarGoodsUpload_,
      indexMethod,
    };
  },
};
