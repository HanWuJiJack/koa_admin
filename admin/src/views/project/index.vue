  ...
  <div class="main">
    ...
    <div class="bottom">
      <div class="bottom-top">
        <el-button type="primary" @click="addHandler" v-permisson="'project-create'"
          >新增</el-button
        >
        <el-button
          type="danger"
          @click="handleDelete1(null, 'dels')"
          v-permisson="'project-deletes'"
          >批量删除</el-button
        >
      </div>
          ...
          <el-table-column label="操作" width="450" fixed="right" align="left">
            <template #default="scope">
              ...
              <el-button
                ...
                size="small"
                @click="handleEdit(scope.row, 'communicate')"
                v-permisson="'project-edit'"
                >填写沟通内容</el-button
              >
              <el-button
                ...
                size="small"
                @click="handleCreatePrice(scope.row)"
                v-permisson="'project-edit'"
                >创建报价单</el-button
              >
              <el-button
              ...
              <el-button
                ...
                size="small"
                v-permisson="'project-edit'"
                @click="handleDelete(scope.row, '5')"
                >合同签订完成</el-button
              >
              <el-button
                ...
                size="small"
                v-permisson="'project-edit'"
                @click="handleDelete(scope.row, '6')"
                >已发货</el-button
              >
              <el-button
                ...
                size="small"
                v-permisson="'project-edit'"
                @click="handleDelete(scope.row, '7')"
                >清点商品中</el-button
              >
              <el-button
                ...
                size="small"
                v-permisson="'project-edit'"
                @click="handleDelete(scope.row, '8')"
                >清点商品完毕</el-button
              >
              <!-- <el-button
                v-show="scope.row.state === '7'"
              ...
              <el-button
                ...
                v-permisson="'project-ditail'"
                >商品清单</el-button
              >
              <el-button
                size="small"
                type="danger"
                @click="handleDelete(scope.row, '21')"
                v-permisson="'project-delete'"
                >作废</el-button
              >
            </template>
          </el-table-column>
      ...
      <el-dialog title="沟通内容" v-model="communicatedialogVisible" width="50%">
        <el-generate-form
          v-if="communicatedialogVisible"
          ref="generateCommunicateFormRef"
          :data="widgetCommunicateForm"
          :value="communicateFormDataInfo"
        ></el-generate-form>
        <template #footer>
          <span class="dialog-footer">
            <el-button @click="dialogCancelHandler">取 消</el-button>
            <el-button type="primary" @click="communicateDialogSubmitHandler"
              >确 定</el-button
            >
          </span>
        </template>
