...
function readDir(obj, nowPath, fatherPath) {
    ...
    // console.log("files", files, nowPath)
...
class FileController extends BaseController {
    ...
    async upload() {
        ...
        const targetDir = path.join(rootPath, `../assets`, fileName);
    ...
    async getZip() {
        ...
        if (zipType === 'zip') {
            ...
            console.log(0, targetDir, filePath)
        ...
        if (zipType === 'zip-spu') {
            ...
            console.log(1, targetDir, filePath)
        ...
        if (zipType === 'zip-sku') {
            ...
            console.log(2, targetDir, filePath)
