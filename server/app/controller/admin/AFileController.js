...
function readDir(obj, nowPath, fatherPath) {
    ...
    files.forEach(function (fileName, index) {//遍历检测目录中的文件
        ...
        if (file.isDirectory()) {//如果是目录的话，继续查询
            ...
            logger.systemLogger.info(" readDir", fileName)
...
class FileController extends BaseController {
    ...
    async get_zip() {
        ...
        if (zipType === 'zip') {
            ...
            logger.systemLogger.info(0, targetDir, filePath)
        ...
        if (zipType === 'zip-spu') {
            ...
            logger.systemLogger.info(1, targetDir, filePath)
        ...
        if (zipType === 'zip-sku') {
            ...
            logger.systemLogger.info(2, targetDir, filePath)
