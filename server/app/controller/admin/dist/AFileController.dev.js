        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 4:
              ...
              filePath = path.join(rootPath, "../assets/".concat(projectInfo, "/").concat(project.name, ".zip"));
            ...
            case 15:
              ...
              _filePath = path.join(rootPath, "../assets/".concat(goodsInfo._doc.projectInfo, "/").concat(goodsInfo._doc.projectInfo, "-").concat(goodsInfo._doc.spu, ".zip"));
              logger.info(1, _targetDir, _filePath);
              _context4.next = 22;
            ...
            case 26:
              ...
              _filePath2 = path.join(rootPath, "../assets/".concat(_goodsInfo._doc.projectInfo, "/").concat(_goodsInfo._doc.projectInfo, "-").concat(_goodsInfo._doc.sku, ".zip"));
              logger.info(2, _targetDir2, _filePath2);
              _context4.next = 33;
